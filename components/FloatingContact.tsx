  ...
  return (
    <div className="fixed bottom-8 right-8 z-[9999] flex flex-col gap-6">
      ...
      <a
        ...
        className="floating-contact-pulse w-16 h-16 bg-white rounded-full shadow-[0_10px_25px_rgba(0,0,0,0.3)] flex items-center justify-center border border-gray-200 overflow-hidden hover:scale-110 transition-transform"
      >
      ...
      <a
        ...
        className="floating-contact-pulse floating-contact-pulse-delayed w-16 h-16 rounded-full shadow-[0_10px_25px_rgba(0,132,255,0.4)] flex items-center justify-center overflow-hidden hover:scale-110 transition-transform"
        style={{
