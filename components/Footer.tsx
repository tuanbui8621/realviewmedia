...
/>
          ...
          <nav aria-labelledby="footer-navigation-heading" className="md:col-span-1">
            ...
            <ul className="space-y-4 text-sm font-light">
              ...
              <li><Link href="/services" className="rounded-sm hover:text-rv-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rv-white">{t('nav.services')}</Link></li>
