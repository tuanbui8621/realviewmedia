...
export default function Navbar() {
  ...
  useEffect(() => {
    // 1. Immediately check scroll position on first load to prevent jumping
  ...
  return (
    <motion.header
      ...
      // 2. Changed 'transition-all' to specific properties so it doesn't fight Framer Motion
      className={`fixed top-0 w-full z-50 transition-[background-color,border-color,height] duration-500 flex items-center ${
        scrolled
